...
const COLORSCHEME = { // props -> this should be associated with the signed in user, or be default
  // light: "white",
  // dark: "#14213D",
  light: "white",
  dark: "#FCA311",
...
function Labels() {
  ...
  return (
    <div className={styles.labels}>
      <svg viewBox="0 0 100 100"><text x="0.75" y="3.5" font-size="2.8" fill={light}>8</text><text x="0.75" y="15.75" font-size="2.8" fill={dark}>7</text><text x="0.75" y="28.25" font-size="2.8" fill={light}>6</text><text x="0.75" y="40.75" font-size="2.8" fill={dark}>5</text><text x="0.75" y="53.25" font-size="2.8" fill={light}>4</text><text x="0.75" y="65.75" font-size="2.8" fill={dark}>3</text><text x="0.75" y="78.25" font-size="2.8" fill={light}>2</text><text x="0.75" y="90.75" font-size="2.8" fill={dark}>1</text><text x="10" y="99" font-size="2.8" fill={dark}>a</text><text x="22.5" y="99" font-size="2.8" fill={light}>b</text><text x="35" y="99" font-size="2.8" fill={dark}>c</text><text x="47.5" y="99" font-size="2.8" fill={light}>d</text><text x="60" y="99" font-size="2.8" fill={dark}>e</text><text x="72.5" y="99" font-size="2.8" fill={light}>f</text><text x="85" y="99" font-size="2.8" fill={dark}>g</text><text x="97.5" y="99" font-size="2.8" fill={light}>h</text></svg>
    </div>)
}
...
export default function NewBoard(props: ChessBoardProps) {
  ...
  const handleClick = (e: React.MouseEvent) => {
    ...
    const r = windowToBoardCoords(boardRef.current!, { x: e?.clientX, y: e?.clientY })
    ...
    if ((convertIndicesToBoardNotation(indices) === props.selection || board[indices.j][indices.i] === null) || (board[indices.j][indices.i]?.color !== color)) {
      // set selection
      props.setSelection("");
    } else {
      // set selection
